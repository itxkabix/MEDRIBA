...
![MEDRIBA - github1](https://github.com/itxkabix/MEDRIBA.git)
...
- **Disease Prediction**: The application utilizes machine learning models to predict the likelihood of having diabetes and heart disease based on the inputted medical data.
...
## Dataset
    Main Target was to train on Indian Dataset. 

- **Heart.csv**: https://www.kaggle.com/datasets/ankushpanday2/heart-attack-risk-and-prediction-dataset-in-india

- **Diabetes.csv**: https://figshare.com/articles/dataset/diabetes_csv/25421347?file=45084472
...
```bash
git clone https://github.com/itxkabix/MEDRIBA.git
```
...
To run the MEDRIBA - Multi-model Expert Digital Responsive Intelligent Bio-health Assistant,
...
5. Click the "Predict" button to generate predictions for diabetes and heart disease based on the provided data.
